...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='SYSU-CD', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--resnet', type=str, default='resnet34', help='resnet18|resnet34|resnet50|resnext50_32x4d|wide_resnet50_2')
        ...
        self.parser.add_argument('--use_ce_loss', default=True, type=bool)
        ...
        self.parser.add_argument('--dataset', type=str, default='SYSU-CD',
